...
To investigate if force-angle data for MVCs follow typical FL relationships in either condition, the maximum force for all angles will and experiments will be plotted. To better see the relationship, the mean maximum force of each angle was calculated.
